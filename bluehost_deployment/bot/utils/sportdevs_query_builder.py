...
class SportDevsQueryBuilder:
    ...
    def order(
        self, order_func: Callable[["SportDevsOrderBuilder"], "SportDevsOrderBuilder"]
    ) -> "SportDevsQueryBuilder":
    ...
    def and_filter(
        self, filter_func: Callable[["SportDevsQueryBuilder"], "SportDevsQueryBuilder"]
    ) -> "SportDevsQueryBuilder":
