...
def sample_user_data() -> Dict[str, Any]:
    ...
    return {
        ...
        "image_path": "/static/guilds/123456789/users/987654321.webp",
        "banner_color": "#00ff00",
        "bet_won": 100.0,
        "bet_loss": 50.0,
        "bet_push": 10.0,
...
@pytest_asyncio.fixture
async def system_integration_service(mock_database_manager, mock_cache_manager):
    """System integration service fixture for testing."""
    from bot.services.system_integration_service import SystemIntegrationService

    service = SystemIntegrationService(mock_database_manager)
