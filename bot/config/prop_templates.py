...
LEAGUE_PROP_GROUPS: Dict[str, Dict[str, List[str]]] = {
    ...
    "NFL": {
        "Passing": ["passing_yards", "passing_touchdowns", "interceptions", "pass_attempts", "pass_completions", "passer_rating", "completion_percentage", "yards_per_attempt", "longest_pass"],
        "Rushing": ["rushing_yards", "rushing_touchdowns", "rush_attempts", "yards_per_carry", "longest_rush"],
        "Receiving": ["receiving_yards", "receptions", "receiving_touchdowns", "targets", "yards_per_reception", "longest_reception"],
        "Scoring": ["touchdowns"],
        "Defense": ["sacks", "sack_yards", "fumbles", "fumbles_lost"],
    },
    "MLB": {
        "Batting": ["hits", "home_runs", "rbis", "runs", "walks", "at_bats", "plate_appearances", "singles", "doubles", "triples", "total_bases", "stolen_bases", "caught_stealing", "batting_average", "on_base_percentage", "slugging_percentage", "ops"],
        "Pitching": ["strikeouts", "innings_pitched", "earned_runs", "hits_allowed", "walks_allowed", "hit_batters", "wild_pitches", "balks", "era", "whip", "strikeouts_per_nine", "walks_per_nine", "hits_per_nine", "home_runs_per_nine", "pitches_thrown", "strikes_thrown", "balls_thrown", "strike_percentage"],
        "Advanced": ["sacrifice_flies", "sacrifice_bunts", "ground_into_double_plays", "hit_by_pitch"],
        "Outcomes": ["wins", "losses", "quality_starts", "complete_games", "shutouts", "saves", "holds", "blown_saves"],
    },
    "NHL": {
        "Scoring": ["goals", "assists", "points", "power_play_goals", "power_play_assists", "power_play_points", "short_handed_goals", "short_handed_assists", "short_handed_points", "game_winning_goals", "overtime_goals", "empty_net_goals"],
        "Shooting": ["shots"],
        "Goaltending": ["saves", "goals_against", "shots_against", "save_percentage", "goals_against_average", "shutouts"],
        ...
        "Time on Ice": ["time_on_ice", "power_play_time", "short_handed_time", "even_strength_time"],
