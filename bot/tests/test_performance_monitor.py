...
class TestPerformanceMonitor:
    ...
    def test_get_health_summary(self):
        ...
        time.sleep(0.001)  # Small delay to ensure different timestamps
        fresh_monitor.add_health_check("check1", "critical", "Critical")  # Override check1
...
class TestMonitorPerformanceDecorator:
    ...
    async def test_monitor_performance_async(self, monitor):
        ...
        with patch('bot.utils.performance_monitor.get_performance_monitor', return_value=monitor):
            # Apply the decorator
