"""CFL team name mappings for normalization."""

# CFL Team Names and their normalized versions
TEAM_NAMES = {
    # Full team names to normalized names
    "british columbia lions": "BC Lions",
    "bc lions": "BC Lions",
    "calgary stampeders": "Calgary Stampeders",
    "edmonton elks": "Edmonton Elks",
    "edmonton eskimos": "Edmonton Elks",  # Old name
