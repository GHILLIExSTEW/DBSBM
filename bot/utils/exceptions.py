...
class DatabaseException(DBSBMBaseException):
    ...
    def __init__(
        self, message: str, query: Optional[str] = None, params: Optional[tuple] = None
    ):
...
class APIException(DBSBMBaseException):
    ...
    def __init__(
        ...
        super().__init__(
            message, "API_ERROR", {"endpoint": endpoint, "status_code": status_code}
        )
...
class AuthenticationException(DBSBMBaseException):
    ...
    def __init__(
        ...
        super().__init__(
            message, "AUTH_ERROR", {"user_id": user_id, "permission": permission}
        )
...
class NetworkException(DBSBMBaseException):
    ...
    def __init__(
        ...
        super().__init__(message, "NETWORK_ERROR", {"host": host, "port": port})
...
class DataIntegrityException(DBSBMBaseException):
    ...
    def __init__(
        ...
        super().__init__(
            message, "DATA_INTEGRITY_ERROR", {"table": table, "constraint": constraint}
        )
