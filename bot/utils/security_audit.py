...
class SecurityAuditor:
    ...
    def __init__(self):
        ...
        self.ignored_directories = {
            ...
            'logs', 'static', 'templates', 'migrations'
        }

        self.ignored_files = {
            '.gitignore', '.env.example', 'requirements.txt',
            'README.md', 'LICENSE', '*.log', '*.pyc'
        }
    ...
    def scan_file(self, file_path: str) -> List[Dict[str, Any]]:
        ...
        try:
            with open(file_path, 'r', encoding='utf-8') as f:
                ...
                issues.extend(self._check_additional_security_issues(
    ...
    def _check_additional_security_issues(self, file_path: str, content: str, lines: List[str]) -> List[Dict[str, Any]]:
        ...
        for severity in ['CRITICAL', 'HIGH', 'MEDIUM', 'LOW']:
            if severity in by_severity:
                ...
                for issue in by_severity[severity]:
                    report += f"• {issue['type']}: {issue.get('file', 'Unknown file')}\n"
                    if 'line' in issue:
                        report += f"  Line {issue['line']}: {issue.get('line_content', '')}\n"
