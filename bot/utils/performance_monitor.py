...
class PerformanceMonitor:
    ...
    def record_response_time(self, operation: str, response_time: float):
        ...
        self.add_metric(f"{operation}_response_time", response_time, {"operation": operation})
    ...
    def record_request(self, endpoint: str, success: bool = True):
        ...
        self.add_metric(f"{endpoint}_requests", 1, {"endpoint": endpoint, "success": str(success)})
    
    def add_health_check(self, name: str, status: str, message: str, details: Optional[Dict[str, Any]] = None):
        """
    ...
    async def check_system_health(self) -> Dict[str, Any]:
        ...
        try:
            ...
            self.add_health_check("system_health", health_status, health_message, self.system_metrics)
            ...
            self.add_health_check("system_health", "critical", f"Health check failed: {e}")
            return {
                "status": "critical",
    ...
    def decorator(func):
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                get_performance_monitor().record_response_time(operation_name, time.time() - start_time)
                return result
            except Exception as e:
                get_performance_monitor().record_response_time(operation_name, time.time() - start_time)
                raise
