...
async def search_wikipedia_player(
...
async def download_image(
    session: aiohttp.ClientSession, image_url: str, file_path: str
) -> bool:
...
async def download_golf_player_photos():
    ...
    try:
        ...
        logger.error(
            "datagolf_players_by_name.json not found. Run save_datagolf_players_dict.py first."
        )
        return
