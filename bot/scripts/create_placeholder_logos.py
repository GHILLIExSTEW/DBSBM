...
def create_all_placeholder_logos():
    ...
    for sport, leagues in leagues_to_create.items():
        ...
        for league_code, league_name in leagues.items():
            ...
            # Create directory
            league_dir = os.path.join(logos_dir, sport_category.upper(), league_code.upper())
...
def main():
    ...
    try:
        ...
        print("💡 You can replace these with real logos later using the collection scripts")
    except Exception as e:
        print(f"❌ Error: {e}")
        return False
