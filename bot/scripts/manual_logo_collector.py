...
class ManualLogoCollector:
    ...
    def download_and_save_logo(self, sport: str, league_code: str, logo_info: Dict) -> bool:
    ...
    def collect_all_logos(self) -> int:
        ...
        logger.info(f"Collection process completed. {successful_downloads}/{total_leagues} logos collected successfully.")
