            ...
            for sport_id in sport_ids:
                ...
                try:
                    ...
                    if data and "DATA" in data:
                        ...
                        logger.info(f"Found player: {player_data.get('NAME', 'Unknown')}")
                        logger.info(f"  Sport ID: {player_data.get('SPORT_ID', 'Unknown')}")
                        logger.info(f"  Country: {player_data.get('COUNTRY_NAME', 'Unknown')}")
                        logger.info(f"  Team: {player_data.get('PARENT_NAME', 'Unknown')}")
                        logger.info("---")
                    else:
