# SCRIPT_DIR is the directory where this script (download_team_logos.py) lives: bot/utils/
# BASE_DIR is the parent of SCRIPT_DIR, which should be the 'bot' root directory
