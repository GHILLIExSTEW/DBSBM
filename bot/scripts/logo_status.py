...
def get_logo_status():
    ...
    expected_structure = {
        "TENNIS": {
            "ATP": ["atp_tour.png", "atp.png"],
            "WTA": ["wta_tour.png", "wta.png"]
        },
        "GOLF": {
            "PGA": ["pga_tour.png", "pga.png"],
            "LPGA": ["lpga_tour.png", "lpga.png"],
            "EUROPEAN_TOUR": ["european_tour.png"],
            "LIV_GOLF": ["liv_golf.png"],
            "KORN_FERRY": ["korn_ferry.png"],
            "CHAMPIONS_TOUR": ["champions_tour.png"],
            "RYDER_CUP": ["ryder_cup.png"],
            "PRESIDENTS_CUP": ["presidents_cup.png"],
            "SOLHEIM_CUP": ["solheim_cup.png"],
            "OLYMPIC_GOLF": ["olympic_golf.png"]
        },
        "RACING": {
            "FORMULA1": ["formula_1.png", "formula1.png"]
        }
    }
    ...
    for sport, leagues in expected_structure.items():
        ...
        for league, expected_files in leagues.items():
            ...
            if os.path.exists(league_dir):
                existing_files = [f for f in os.listdir(league_dir) if f.endswith('.png')]
