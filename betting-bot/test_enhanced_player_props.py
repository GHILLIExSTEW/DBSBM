...
async def test_enhanced_player_props():
    ...
    try:
        ...
        print("\n1️⃣ Testing imports...")
        from config.prop_templates import get_prop_templates_for_league, get_prop_groups_for_league
        ...
        try:
            ...
            from commands.enhanced_player_prop_modal import EnhancedPlayerPropModal, PlayerPropSearchView
