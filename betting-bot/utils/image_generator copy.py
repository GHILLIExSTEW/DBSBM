...
class BetSlipGenerator:
    ...
    def _draw_player_prop_section(
        ...
        regenerate_logo: bool = True  # New parameter to control logo regeneration
    ):
        y_base = 85
        logo_size = (120, 120)
    ...
    def _load_team_logo(self, team_name: str, league: str) -> Optional[Image.Image]:
        try:
            ...
            # Always normalize to 'St. <Rest>' (with a space), then remove periods before passing to normalize_team_name for filename
