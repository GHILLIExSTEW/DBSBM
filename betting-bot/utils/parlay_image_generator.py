# This file contains the logic for generating parlay bet images.
...
class ParlayImageGenerator:
    ...
    def draw_parlay_details(self, draw, image_width, image_height, legs, odds, units, bet_id, timestamp, is_same_game, img, team_logos):
        ...
        draw.text((self.padding, y_base), odds_text, font=leg_font, fill="gold")
        y_base += text_y_offset
        draw.text((self.padding, y_base), units_text, font=leg_font, fill="gold")
