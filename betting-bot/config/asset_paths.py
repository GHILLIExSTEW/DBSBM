...
SPORT_CATEGORIES = {
    ...
    "SOCCER": [
        ...
        "Elitettan",
        "Svenska_Cupen",
        "Svenska_Cupen_-_Women",
        "Ettan_-_Norra",
        "Ettan_-_Södra",
        "Ettan_-_Relegation_Round",
        "Division_2_-_Norra_Götaland",
        "Division_2_-_Norra_Svealand",
        "Division_2_-_Norrland",
        "Division_2_-_Södra_Svealand",
        "Division_2_-_Västra_Götaland",
        "Division_2_-_Östra_Götaland",
    ],
    "TENNIS": [
        "ATP",
        "WTA",  # Current leagues
    ...
    "AUSTRALIAN_FOOTBALL": ["AFL", "AFLW", "VFL", "SANFL", "WAFL", "NEAFL"],
    "VOLLEYBALL": [
        "FIVB",
        "CEV",
        "AVC",
    ...
    "LACROSSE": ["NLL", "PLL", "MLL", "WORLD_LACROSSE_CHAMPIONSHIP"],
    "FIELD_HOCKEY": [
        "FIH_PRO_LEAGUE",
        "WORLD_CUP",
        "OLYMPIC_FIELD_HOCKEY",
        "EUROPEAN_CHAMPIONSHIP",
        "PAN_AMERICAN_CUP",
    ],
    "BADMINTON": [
