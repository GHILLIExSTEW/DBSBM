#!/usr/bin/env python3
"""
Advanced Analytics Migration Runner
Runs the advanced analytics tables migration for Phase 4 Task 4.2
"""
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('migration_017_advanced_analytics.log'),
...
async def run_advanced_analytics_migration():
    """Run the advanced analytics migration."""
    db_manager = DatabaseManager()

    try:
        logger.info("Starting Advanced Analytics migration...")
        ...
        migration_file = Path(__file__).parent.parent / \
            "migrations" / "017_advanced_analytics_tables.sql"
...
if __name__ == "__main__":
    success = asyncio.run(run_advanced_analytics_migration())
